    ...
    <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                ...
                <img src={log2} className="h-11"></img>
                </a>
                <p className="mt-2 text-sm text-gray-500">Learn,Make others Learn!</p>
                <div className="mt-4">
            ...
            <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">Motto</a>
                        </li>
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">office</a>
                        </li>
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">Rights</a>
                        </li>
                    </nav>
                </div>
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        ...
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">+91 9192939495</a>
                        </li>
                    </nav>
                </div>
            </div>
